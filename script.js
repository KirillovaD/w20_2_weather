...
//   fetch("https://api.openweathermap.org/data/2.5/weather?id=524901&appid=96dffe7fd042dca7badf6ff1cd796eff")
// //   .then(response => response.json()) 
// //     .then(weather => {
// //       console.log(weather);
// //       document.getElementById("city").textContent = weather.name;
// //       document.getElementById("temp").textContent = weather.main.temp;
// //       document.getElementById("feelsTemp").textContent = weather.main.feels_like;
